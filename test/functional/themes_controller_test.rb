...
class ThemesControllerTest < ActionController::TestCase
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post :create, theme: { description: @theme.description, image: @theme.image, language_id: @theme.language_id, name: @theme.name }
    end
  ...
  test "should update theme" do
    put :update, id: @theme, theme: { description: @theme.description, image: @theme.image, language_id: @theme.language_id, name: @theme.name }
    assert_redirected_to theme_path(assigns(:theme))
  end
